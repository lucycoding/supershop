...
class PageDesk{
    ...
    private $config  = array(
        ...
        'first'  => '首页',
        'last'   => '末页',
        'theme'  => '<div class="pagination"><ul><li>%FIRST%</li><li>%UP_PAGE%</li>%LINK_PAGE%<li>%DOWN_PAGE%</li><li>%END%</li><li><a>%NOW_PAGE%/%TOTAL_PAGE%</a></li><li><a>%HEADER%</a></li></ul></div>',
    );
        ...
        $link_page = "";
         for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0){
                    $link_page .= '<li class="curent"><a>' . $page . '</a></li>';
                }
            }
        }
