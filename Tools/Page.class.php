...
class Page{
    ...
    private $config  = array(
        ...
        'first'  => '首页',
        'last'   => '末页',
        'theme'  => '<div class="pagination pagination-centered"><ul></li><li>%FIRST%</li><li>%UP_PAGE%</li>%LINK_PAGE%<li>%DOWN_PAGE%</li><li>%END%</li><li><a>%NOW_PAGE%/%TOTAL_PAGE%</a></li><li><a>%HEADER%</a></li></ul></div>',
    );
